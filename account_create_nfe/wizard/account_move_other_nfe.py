...
class AccountMoveOtherNfe(models.TransientModel):
    """
    Criar outra account.move para gerar NFe somente itens
    """
    _name = 'account.move.other.nfe'
    _description = 'Account Move Other NFe'
    ...
    def default_get(self, fields):
        import pudb;pu.db
        res = super(AccountMoveOtherNfe, self).default_get(fields)
