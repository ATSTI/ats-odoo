...
def post_init_hook(cr, registry):
    ...
    cr.execute(
        """
            SELECT id, name, company_id, invoice_eletronic_id, product_id, tipo_produto, cfop, ncm, uom_id, quantidade, preco_unitario, pedido_compra,
                ...
                inss_valor_retencao, account_invoice_line_id, create_uid, create_date, write_uid, write_date, cest, classe_enquadramento_ipi, codigo_enquadramento_ipi,
                ...
                icms_uf_dest, icms_fcp_uf_dest, informacao_adicional, icms_substituto, icms_bc_st_retido, icms_aliquota_st_retido, icms_st_retido, importado, num_item
        	FROM public.invoice_eletronic_item;
        """
    )
