...
def post_init_hook(cr, registry):
    ...
    # FRADE FLORES 02/02/2026
    # ----------- br_odoo_nfe --------
    # insert into br_odoo_nfe (id, code, name, company_id, state, schedule_user_id, tipo_operacao, model, serie, serie_documento, numero, numero_controle, data_agendada, data_emissao, data_autorizacao, data_fatura, ambiente, finalidade_emissao, invoice_id, partner_id, commercial_partner_id, partner_shipping_id, payment_term_id, fiscal_position_id, valor_bruto, valor_frete, valor_seguro, valor_desconto, valor_despesas, valor_bc_icms, valor_icms, valor_icms_deson, valor_bc_icmsst, valor_icmsst, valor_ii, valor_ipi, valor_pis, valor_cofins, valor_estimado_tributos, valor_servicos, valor_bc_issqn, valor_issqn, valor_pis_servicos, valor_cofins_servicos, valor_retencao_issqn, valor_retencao_pis, valor_retencao_cofins, valor_bc_irrf, valor_retencao_irrf, valor_bc_csll, valor_retencao_csll, valor_bc_inss, valor_retencao_inss, valor_final, informacoes_legais, informacoes_complementares, codigo_retorno, mensagem_retorno, numero_nfe, xml_to_send, xml_to_send_name, email_sent, payment_mode_id, iest, ambiente_nfe, ind_final, ind_pres, ind_dest, ind_ie_dest, tipo_emissao, modalidade_frete, placa_veiculo, uf_veiculo, rntc, local_embarque, local_despacho, numero_fatura, fatura_bruto, nota_empenho, pedido_compra, contrato_compra, sequencial_evento, recibo_nfe, chave_nfe, protocolo_nfe, nfe_processada, nfe_processada_name, valor_icms_uf_remet, valor_icms_uf_dest, valor_icms_fcp_uf_dest, qrcode_hash, qrcode_url, metodo_pagamento, valor_pago, troco, create_uid, create_date, write_uid, write_date) 
    # select id, code, name, company_id, state, schedule_user_id, tipo_operacao, model, serie, serie_documento, numero, numero_controle, data_agendada, data_emissao, data_autorizacao, data_fatura, ambiente, finalidade_emissao, invoice_id, partner_id, commercial_partner_id, partner_shipping_id, payment_term_id, fiscal_position_id, valor_bruto, valor_frete, valor_seguro, valor_desconto, valor_despesas, valor_bc_icms, valor_icms, valor_icms_deson, valor_bc_icmsst, valor_icmsst, valor_ii, valor_ipi, valor_pis, valor_cofins, valor_estimado_tributos, valor_servicos, valor_bc_issqn, valor_issqn, valor_pis_servicos, valor_cofins_servicos, valor_retencao_issqn, valor_retencao_pis, valor_retencao_cofins, valor_bc_irrf, valor_retencao_irrf, valor_bc_csll, valor_retencao_csll, valor_bc_inss, valor_retencao_inss, valor_final, informacoes_legais, informacoes_complementares, codigo_retorno, mensagem_retorno, numero_nfe, xml_to_send, xml_to_send_name, email_sent, payment_mode_id, iest, '1', ind_final, ind_pres, ind_dest, ind_ie_dest, tipo_emissao, modalidade_frete, placa_veiculo, uf_veiculo, rntc, local_embarque, local_despacho, numero_fatura, fatura_bruto, nota_empenho, pedido_compra, contrato_compra, sequencial_evento, recibo_nfe, chave_nfe, protocolo_nfe, nfe_processada, nfe_processada_name, valor_icms_uf_remet, valor_icms_uf_dest, valor_icms_fcp_uf_dest, qrcode_hash, qrcode_url, metodo_pagamento, valor_pago, troco, create_uid, create_date, write_uid, write_date from invoice_eletronic;
    # ----------- br_odoo_nfe --------

    # cr.execute(
                # CAPTAINDIVE
                # insert into br_odoo_nfe (id, code, name, company_id, state, schedule_user_id, tipo_operacao, model, serie, serie_documento, numero, numero_controle, data_agendada, data_emissao, data_autorizacao, data_fatura, ambiente, finalidade_emissao, invoice_id, partner_id, commercial_partner_id, partner_shipping_id, payment_term_id, fiscal_position_id, valor_bruto, valor_frete, valor_seguro, valor_desconto, valor_despesas, valor_bc_icms, valor_icms, valor_icms_deson, valor_bc_icmsst, valor_icmsst, valor_ii, valor_ipi, valor_pis, valor_cofins, valor_estimado_tributos, valor_servicos, valor_bc_issqn, valor_issqn, valor_pis_servicos, valor_cofins_servicos, valor_retencao_issqn, valor_retencao_pis, valor_retencao_cofins, valor_bc_irrf, valor_retencao_irrf, valor_bc_csll, valor_retencao_csll, valor_bc_inss, valor_retencao_inss, valor_final, informacoes_legais, informacoes_complementares, codigo_retorno, mensagem_retorno, numero_nfe, xml_to_send, xml_to_send_name, email_sent, payment_mode_id, iest, ambiente_nfe, ind_final, ind_pres, ind_dest, ind_ie_dest, tipo_emissao, modalidade_frete, transportadora_id, placa_veiculo, uf_veiculo, rntc, uf_saida_pais_id, local_embarque, local_despacho, numero_fatura, fatura_bruto, fatura_desconto, fatura_liquido, nota_empenho, pedido_compra, contrato_compra, sequencial_evento, recibo_nfe, chave_nfe, protocolo_nfe, nfe_processada, nfe_processada_name, valor_icms_uf_remet, valor_icms_uf_dest, valor_icms_fcp_uf_dest, qrcode_hash, qrcode_url, metodo_pagamento, valor_pago, troco, create_uid, create_date, write_uid, write_date) 
				# select id, code, name, company_id, state, schedule_user_id, tipo_operacao, model, serie, serie_documento, numero, numero_controle, data_agendada, data_emissao, data_autorizacao, data_fatura, ambiente, finalidade_emissao, invoice_id, partner_id, commercial_partner_id, partner_shipping_id, payment_term_id, fiscal_position_id, valor_bruto, valor_frete, valor_seguro, valor_desconto, valor_despesas, valor_bc_icms, valor_icms, valor_icms_deson, valor_bc_icmsst, valor_icmsst, valor_ii, valor_ipi, valor_pis, valor_cofins, valor_estimado_tributos, valor_servicos, valor_bc_issqn, valor_issqn, valor_pis_servicos, valor_cofins_servicos, valor_retencao_issqn, valor_retencao_pis, valor_retencao_cofins, valor_bc_irrf, valor_retencao_irrf, valor_bc_csll, valor_retencao_csll, valor_bc_inss, valor_retencao_inss, valor_final, informacoes_legais, informacoes_complementares, codigo_retorno, mensagem_retorno, numero_nfe, xml_to_send, xml_to_send_name, email_sent, payment_mode_id, iest, '1', ind_final, ind_pres, ind_dest, ind_ie_dest, tipo_emissao, modalidade_frete, transportadora_id, placa_veiculo, uf_veiculo, rntc, uf_saida_pais_id, local_embarque, local_despacho, numero_fatura, fatura_bruto, fatura_desconto, fatura_liquido, nota_empenho, pedido_compra, contrato_compra, sequencial_evento, recibo_nfe, chave_nfe, protocolo_nfe, nfe_processada, nfe_processada_name, valor_icms_uf_remet, valor_icms_uf_dest, valor_icms_fcp_uf_dest, qrcode_hash, qrcode_url, metodo_pagamento, valor_pago, troco, create_uid, create_date, write_uid, write_date
