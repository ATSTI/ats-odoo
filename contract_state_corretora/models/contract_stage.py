...
class ContractStage(models.Model):
    ...
    _description = 'Estagio Contrato'
    _order = 'sequence, name, id'

    name = fields.Char(string='Estágio', required=True)
    ...
    is_closed = fields.Boolean('Estágio Fechado',
                               help='Services in this stage are considered '
                                    'as closed.')
    is_default = fields.Boolean('Estágio padrão',
    ...
    #     for stage in stages:
    #     return super(ContractStage, self).create(vals)
