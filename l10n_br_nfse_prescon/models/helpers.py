...
"""Helper functions for Prescon NFSe integration."""

from .constants import CNPJ_LENGTH, CPF_LENGTH, PDF_FOOTER, PDF_HEADER


def filter_prescon(record):
    """Filter records with Prescon provider."""
    return record.company_id.provedor_nfse == "prescon"


def filter_prescon_nacional(record):
