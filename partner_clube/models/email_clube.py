...
class EmailClube(models.Model):
    _name = 'email.clube'
    _inherit = ['mail.thread']
    _description = "Enviar Emails"
    ...
    def _send_mail_lista_niver(self, ids, mail_to, email_from=None, context=None):
        # EMAIL COM LISTA DOS ANIVERSARIANTES
        mail_to = 'crsilveira@gmail.com;carlos@atsti.com.br'
        corpo = ''
