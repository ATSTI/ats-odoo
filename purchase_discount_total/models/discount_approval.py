    ...
    def action_confirm(self):
        ...
        if self.company_id.so_double_validation == 'two_step':
            ...
            if self.company_id.so_double_validation_limit and discnt > self.company_id.so_double_validation_limit:
                self.state = 'waiting'
                return True
        super(purchase_discount, self).action_confirm()
...
class Company(models.Model):
    ...
    so_double_validation = fields.Selection([
        ...
        help="Provide a double validation mechanism for purcahses discount")
...
class ResDiscountSettings(models.TransientModel):
    ...
    so_order_approval = fields.Boolean("Purchase Discount Approval", default=lambda self: self.env.user.company_id.so_double_validation == 'two_step')
