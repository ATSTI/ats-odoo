...
class FreteReport(models.AbstractModel):
    ...
    @api.model
    def _get_tax_report_domain(self, company_id, date_from, date_to, only_posted_moves, accounts_ids=None):
        import pudb;pu.db
        domain = [
    ...
    @api.model
    def _get_net_report_domain(self, company_id, date_from, date_to, only_posted_moves, accounts_ids=None):
        import pudb;pu.db        
        domain = [
            ("company_id", "=", company_id),
            ("date", ">=", date_from),
    ...
    def _get_frete_report_data(self, company_id, date_from, date_to, accounts_ids=None):
        ...
        tax_domain = self._get_tax_report_domain(
            company_id, date_from, date_to, True
        )
