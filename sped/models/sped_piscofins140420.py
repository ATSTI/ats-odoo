...
class SpedPisCofins(models.Model):
    ...
    def registro0000(self, inv):
        ...
        regC010.CNPJ = self.company_id.cnpj_cpf
        regC010.IND_ESCRI = '2'
        ...
        regM200.VL_TOT_CONT_CUM_PER = '0'
        regM200.VL_RET_CUM = '0'
        regM200.VL_OUT_DED_CUM = '0'
        regM200.VL_CONT_CUM_REC = '0'
        regM200.VL_TOT_CONT_REC = '0'
        arq._blocos['M'].add(regM200)
        
        regM400 = RegistroM400()
        regM400.CST_PIS = '06'
        #TODO VL_TOT_REC CARREGAR VALOR.
        regM400.VL_TOT_REC = '0'
        regM400.COD_CTA = '1.1.06.11.00.00'
        arq._blocos['M'].add(regM400)
        
        regM410 = RegistroM410()
        #TODO NAT.REC PEGAR DOS 3 PRIMEIROS CARACTERES DAS CATEGORIAS PAI DE CADA PRODUTO.
        regM410.NAT_REC = '06'
        #TODO VL_REC CARREGAR VALOR.
        regM410.VL_REC = '0'
        regM410.COD_CTA = '1.1.06.11.00.00'
        arq._blocos['M'].add(regM410)
        ...
        regM600.VL_TOT_CONT_CUM_PER = '0'
        regM600.VL_RET_CUM = '0'
        regM600.VL_OUT_DED_CUM = '0'
        regM600.VL_CONT_CUM_REC = '0'
        regM600.VL_TOT_CONT_REC = '0'
        arq._blocos['M'].add(regM600)
        ...
        regM810 = RegistroM810()
        #TODO NAT.REC PEGAR DOS 3 PRIMEIROS CARACTERES DAS CATEGORIAS PAI DE CADA PRODUTO.
        regM810.NAT_REC = '06'
        #TODO VL_REC CARREGAR VALOR.
        regM810.VL_REC = '0'
        regM810.COD_CTA = '1.1.06.11.00.00'
        arq._blocos['M'].add(regM810)
